<template>
    <div style="width: 60%;margin-left: 20%;">
        ...
        <van-cell-group>
            <!--<van-cell>
                <van-col span="21" style="width: 140px"></van-col>
        ...
        <van-cell-group>
            <van-cell>
                ...
                <!-- <van-col style="width: 140px;margin-left: 60px" v-if="orderInfo.orderStat===2"></van-col>
                <van-col style="width: 140px;margin-left: 60px" v-if="orderInfo.orderStat===3">，</van-col>
                <van-col style="width: 140px;margin-left: 60px" v-if="orderInfo.orderStat===4"></van-col> -->
            </van-cell>
            <van-cell>
            ...
            <!--<van-cell>
                <van-col span="21" style="width: 140px"></van-col>
                <van-col style="width: 80px;margin-left: 60px"></van-col>
            </van-cell>-->
        </van-cell-group>

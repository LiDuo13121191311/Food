                    ...
                    <div style="border-radius: 10px;background-color: white"  @click="toShop(shop)">
                        ...
                        <div style="">
                            ...
                            <div style="width: 195px;padding-left: 80px;text-align: left">
                                <span style="font-size: 15px;">{{shop.totalSales}}</span><br>
                            </div>
                            <!-- <div style="width: 195px;font-size: 15px;padding-left: 80px;text-align: left">
                                ...
                                <span style="margin: 5px" v-if="shop.deliveryTime===null">40</span>
                                <span style="margin: 5px" v-if="shop.deliveryTime!==null">{{shop.deliveryTime}}</span>
                                <br>
                            </div> -->
                ...
                shops:[
                    {
                        ...
                        deliveryCost:"3",
                        deliveryTime:"40",
                        logoSrc:"upload/logo_20210905175221.png"
                    },
